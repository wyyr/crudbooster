                ...
                <div class="card-body">
                    ...
                    <div class='form-group'>
                        ...
                        <div id='set_as_superadmin' class='radio'>
                            ...
                            &nbsp;&nbsp;
                            <label><input {{ $row?->is_superadmin == 0 ? 'checked' : '' }} type='radio'
                        ...
                        <table class="table table-md table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                @foreach ($moduls as $modul)
                                    <?php
                                    $current_row_id = $row?->id ?? 0;
                                    $roles = DB::table('cms_privileges_roles')->where('id_cms_moduls', $modul->id)->where('id_cms_privileges', $current_row_id)->first();
                                    ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td>{{ $modul->name }}</td>
