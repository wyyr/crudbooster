                            ...
                            <div id='advanced_export' style='display: none'>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class='form-control' name='page_size'>
                                        <option <?= get_setting('default_paper_size') == 'Letter' ? 'selected' : '' ?>
                                            value='Letter'>Letter</option>
                                        <option <?= get_setting('default_paper_size') == 'Legal' ? 'selected' : '' ?>
                                            value='Legal'>Legal</option>
                                        <option <?= get_setting('default_paper_size') == 'Ledger' ? 'selected' : '' ?>
                                            value='Ledger'>Ledger</option>
                                        <?php for($i = 0;$i <= 8;$i++):
                                        $select = (get_setting('default_paper_size') == 'A'.$i) ? "selected" : "";
                                        ?>
                                        ...
                                        <?php for($i = 0;$i <= 10;$i++):
                                        $select = (get_setting('default_paper_size') == 'B'.$i) ? "selected" : "";
                                        ?>
