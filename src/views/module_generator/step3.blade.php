    ...
    <form method="post" autocomplete="off" action="{{ Route('ModulControllerPostStep4') }}">
        <div class="card card-light">
            ...
            <div class="card-body">
                ...
                <table class="table-form table table-striped table-sm">
                    <thead>
                        <tr>
                            <th>Label</th>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($cb_form as $form)
                            <tr>
                                ...
                                <td><input type='text' value='{{ $form['type'] ?? 'text' ?: 'text' }}'
                                ...
                                <td><input type='text' value='{{ $form['validation'] ?? '' }}'
                                        class='form-control validation' onclick="showValidationSuggest(this)"
                                ...
                                <td>
                                    <select class='form-control width' name='width[]'>
                                        @for ($i = 10; $i >= 1; $i--)
                                            <option {{ ($form['width'] ?? '') == "col-sm-$i" ? 'selected' : '' }}
                                ...
                                $type = ($form['type'] ?? 'text') ?: 'text';
                                $types = base_path('vendor/wyyr/crudbooster/src/views/default/type_components/'.$type.'/info.json');
                        ...
                        <tr id='tr-sample' style="display: none">
                            ...
                            <td>
                                <select class="form-control width pr-0" name="width[]">
                                    @for ($i = 10; $i >= 1; $i--)
