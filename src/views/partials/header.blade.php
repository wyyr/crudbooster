...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right ml-auto">
        <li class="dropdown dropdown-list-toggle notifications-menu">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                <div class="dropdown-footer text-center">
                    <a href="{{ route('NotificationControllerGetIndex') }}">{{ cbLang('text_view_all_notification') }}
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
                ...
                <div class="d-sm-none d-lg-inline-block">Hi, {{ CRUDBooster::myName() }}</div>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                {{--                <div class="dropdown-title">Logged in 5 min ago</div> --}}
                <a href="{{ route('CmsUserControllerGetProfile') }}" class="dropdown-item has-icon">
